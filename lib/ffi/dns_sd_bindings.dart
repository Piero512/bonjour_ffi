...
class DnsSdAdapterBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  DnsSdAdapterBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  DnsSdAdapterBindings.fromLookup(
      ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
          lookup)
      : _lookup = lookup;

  ffi.Pointer<DNSSDAdapter> get_new_instance() {
    return _get_new_instance();
  }

  late final _get_new_instancePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<DNSSDAdapter> Function()>>(
          'get_new_instance');
  late final _get_new_instance =
      _get_new_instancePtr.asFunction<ffi.Pointer<DNSSDAdapter> Function()>();

  void delete_instance(
    ffi.Pointer<DNSSDAdapter> instance,
  ) {
  ...
  late final _delete_instancePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<DNSSDAdapter>)>>(
          'delete_instance');
  late final _delete_instance = _delete_instancePtr
      .asFunction<void Function(ffi.Pointer<DNSSDAdapter>)>();
  ...
  ffi.Pointer<ResolveContext> search_for_service(
    ffi.Pointer<DNSSDAdapter> adapter,
  ...
  late final _search_for_servicePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ResolveContext> Function(ffi.Pointer<DNSSDAdapter>,
  ...
  late final _search_for_service = _search_for_servicePtr.asFunction<
      ffi.Pointer<ResolveContext> Function(
          ffi.Pointer<DNSSDAdapter>, ffi.Pointer<ffi.Int8>, int)>();
  ...
  late final _stop_search = _stop_searchPtr.asFunction<
      void Function(ffi.Pointer<DNSSDAdapter>, ffi.Pointer<ResolveContext>)>();
}

class DNSSDAdapter extends ffi.Opaque {}
